...
// 👇 Use the collections your key exposes
const targets = [
  // Roads (centre-lines)
  { id: 'trn-ntwk-roadlink-5', filter: '' },        // start with no filter
  // Optional extras:
  // { id: 'trn-ntwk-street-1', filter: '' },
  // { id: 'trn-ntwk-connectinglink-1', filter: '' },
  // { id: 'trn-ntwk-pathlink-3', filter: '' },      // footway/cycle/paths
  // { id: 'trn-ntwk-pavementlink-1', filter: '' },
  // Sites (for Car Parks etc.)
  { id: 'lus-fts-site-2', filter: '' },             // fetch first, then refine to Car Park
];
